 ...
 * generated in the net.bk package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetName_QNAME = new QName("http://bk.net/", "getName");
    private final static QName _GetNameResponse_QNAME = new QName("http://bk.net/", "getNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.bk
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bk.net/", name = "getName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bk.net/", name = "getNameResponse")
